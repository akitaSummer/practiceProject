...
// var ex4 = undefined
var ex4 = _.compose(parseInt, Maybe.of)
...
// var ex5 = undefined
var ex5 = _.compose(_.map(_.compose(toUpperCase, _.prop('title'))), _.compose(Maybe.of, getPost))
...
var ex7 = function(x) {
    ...
    return length > 3 ? Rigth.of(x) : Left.of("You need > 3")
}
