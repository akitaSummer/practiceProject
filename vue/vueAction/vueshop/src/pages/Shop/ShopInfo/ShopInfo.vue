      ...
      <div class="info-content" v-if="info">
        <section class="section">
          ...
          <div class="delivery">
            ...
            <div class="delivery-money">配送费￥{{info.minPrice}}</div>
          </div>
        </section>
        <div class="split"></div>
        <section class="section">
          ...
          <div class="activity">
            <div class="activity-item activity-green" :class="supportsClass[support.type]" v-for="(support, i) in info.supports" :key="'infoSupport' + i">
...
<span class="mini-tag">{{support.name}}</span>
        ...
        <section class="section">
          ...
          <div class="pic-wrapper">
            <ul class="pic-list">
              <li class="pic-item" v-for="(pic, i) in info.pics" :key="'infoPic' + i">
