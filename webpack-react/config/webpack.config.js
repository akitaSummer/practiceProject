...
module.exports = function(webpackEnv) {
    ...
    return {
        ...
        bail: isEnvProduction, // bail：遇到错误停止打包
        ...
        output: {
            ...
            pathinfo: isEnvDevelopment, // 将引入的模块利用注释有所输出
            ...
            devtoolModuleFilenameTemplate: isEnvProduction ? // 帮助1source-map帮助指定到代码行数
                info =>
                path
        ...
        module: {
            ...
            rules: [
                ...
                },
                {
                    ...
                    oneOf: [ // 无后缀时逐个查找，至第一个满足时执行loader
